...
| **data** | `Managers/KeyValueStore.swift`, `Services/AtomicFileWriter.swift`, `Managers/LocalLibraryManager.swift`, `Models/*` stores, schema/migrations, queue persistence | Aria | iOS — Data, Queue & Persistence | `feat/data-hermetic-heal-tests` | in-PR |
