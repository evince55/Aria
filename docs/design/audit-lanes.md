...
| **ui** | `Views/**`, `Resources/DesignSystem*`, `ThemeManager`, `Services/AsyncCachedImage.swift`, Dynamic Type, VoiceOver, iPad | Aria | iOS — UX, Architecture & Accessibility; iOS — Search & Discovery (UI) | `feat/ui-artwork-placeholder` | in-PR |
